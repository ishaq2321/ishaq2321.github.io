...
export const skillIcons: Record<string, string | null> = {
  ...
  // Simple Icons has no `tree-sitter` glyph — the slug 404s on every page load,
  // so these fall back to the plain dot like the other unmapped skills.
  "Tree-sitter AST": null,
